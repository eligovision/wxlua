...
class wxSlider : public wxControl
{
    ...
    %wxcompat_2_8 void SetTickFreq(int n, int pos);
...
// ---------------------------------------------------------------------------
// wxSpinDoubleEvent - for wxSpinCtrlDouble
...
%wxcompat_2_8 #define wxTE_AUTO_SCROLL
...
%wxcompat_2_8 #define wxTR_EXTENDED
