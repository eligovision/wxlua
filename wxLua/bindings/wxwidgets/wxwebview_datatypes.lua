-- ---------------------------------------------------------------------------
-- ../bindings/wxwidgets/wxwebview_datatypes.lua was generated by genwxbind.lua
--
...
wxwebview_dataTypeTable =
{
  ...
  wxBrushStyle = {
    Condition = "(wxLUA_USE_wxColourPenBrush) && (wxCHECK_VERSION(3,1,1))",
    IsNumber = true,
    Name = "wxBrushStyle",
    ValueType = "enum",
  },
  ...
  wxFontSymbolicSize = {
    Condition = "(wxLUA_USE_wxFont) && (wxCHECK_VERSION(3,1,1))",
    IsNumber = true,
  ...
  wxSizeConvention = {
    Condition = "(wxLUA_USE_wxFileName) && (wxCHECK_VERSION(3,1,1))",
    IsNumber = true,
  ...
  wxWebViewFactory = {
    ...
    Condition = "wxUSE_WEBVIEW",
    IsNumber = false,
    Name = "wxWebViewFactory",
    ValueType = "class",
  },
  wxWebViewFindFlags = {
    Condition = "wxUSE_WEBVIEW",
    IsNumber = true,
    Name = "wxWebViewFindFlags",
    ValueType = "enum",
  },
  wxWebViewHandler = {
    Condition = "wxUSE_WEBVIEW",
    IsNumber = false,
    Name = "wxWebViewHandler",
    ValueType = "class",
  },
  wxWebViewHistoryItem = {
    Condition = "wxUSE_WEBVIEW",
    IsNumber = false,
    Name = "wxWebViewHistoryItem",
    ValueType = "class",
  },
  wxWebViewNavigationError = {
    Condition = "wxUSE_WEBVIEW",
    IsNumber = true,
    Name = "wxWebViewNavigationError",
    ValueType = "enum",
  },
  wxWebViewReloadFlags = {
    Condition = "wxUSE_WEBVIEW",
    IsNumber = true,
    Name = "wxWebViewReloadFlags",
    ValueType = "enum",
  },
  wxWebViewZoom = {
    Condition = "wxUSE_WEBVIEW",
...
-- ---------------------------------------------------------------------------
wxwebview_preprocConditionTable =
{
...
-- Cache the dataTypes
-- ---------------------------------------------------------------------------
    for k, v in pairs(wxwebview_typedefTable) do
        typedefTable[k] = v
    end
    for k, v in pairs(wxwebview_dataTypeTable) do
        dataTypeTable[k] = v
    end
    for k, v in pairs(wxwebview_preprocConditionTable) do
