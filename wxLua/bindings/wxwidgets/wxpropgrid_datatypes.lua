-- ---------------------------------------------------------------------------
-- ../bindings/wxwidgets/wxpropgrid_datatypes.lua was generated by genwxbind.lua
--
...
-- ---------------------------------------------------------------------------
wxpropgrid_preprocConditionTable =
{
...
-- Cache the dataTypes
-- ---------------------------------------------------------------------------
    for k, v in pairs(wxpropgrid_typedefTable) do
        typedefTable[k] = v
    end
    for k, v in pairs(wxpropgrid_dataTypeTable) do
        dataTypeTable[k] = v
    end
    for k, v in pairs(wxpropgrid_preprocConditionTable) do
