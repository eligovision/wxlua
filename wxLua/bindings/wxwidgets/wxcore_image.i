...
class wxArtProvider : public wxObject
{
    ...
    !%wxchkver_3_3 static wxSize GetSizeHint(const wxString& client, bool platform_dependent = false);
    %wxchkver_3_3 static wxSize GetSizeHint(const wxString& client, wxWindow* win = nullptr);
    %wxcompat_3_0 static void RescaleBitmap(wxBitmap& bmp, const wxSize& sizeNeeded);
};
